      ...
      <Modal title="리그전 안내" description="진행 방식과 동률 처리 기준" onClose={onClose}>
        <div className="competition-rules-content" tabIndex={0} aria-label="리그전 진행 방식과 순위 안내">
          <section>
            ...
            <ol>
              <li>전체 경기에서 거둔 <strong>승리 수</strong></li>
              <li>승리 수가 같은 경우, <strong>해당 사람들끼리의 승패</strong></li>
              <li>전체 경기에서 <strong>승리한 세트 수</strong></li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol>
              <li>팀 대결에서 거둔 <strong>승리 수</strong></li>
              <li>승리 수가 같은 경우, <strong>해당 팀끼리의 승패</strong></li>
              <li>전체 경기에서 <strong>승리한 세트 수</strong></li>
            </ol>
            <p className="competition-rules-note">승리한 세트 수는 단식·복식에서 얻은 세트를 모두 합산합니다.</p>
          </section>
